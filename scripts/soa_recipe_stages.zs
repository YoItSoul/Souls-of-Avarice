...
Recipes.setRecipeStage("awakened", <item:soa_additions:creative_modifier>);
...
Recipes.setRecipeStage("chaotic", <item:avaritia:infinity_catalyst>);
...
Recipes.setRecipeStage("descendant_of_the_sun", <item:soa_additions:infernium_block>);
...
Recipes.setRecipeStage("fusion_matrix", <item:soa_additions:electronium_block>);
...
Recipes.setRecipeStage("fusion_matrix", <item:summoningrituals:altar>);
...
Recipes.setRecipeStage("getting_started", <item:defiled_lands_preborn:tenebra_planks>);
...
Recipes.setRecipeStage("master_engineer", <item:mekanism:ultimate_control_circuit>);
...
Recipes.setRecipeStage("wielder_of_infinity", <item:soa_additions:difficulty_changer>);
...
Recipes.setRecipeStage("tactic_blueprint", <resource:smithery:rapier_assembly>);
Recipes.setRecipeStage("tactic_blueprint", <resource:smithery:cleaver_assembly>);
Recipes.setRecipeStage("shuriken_blueprint", <resource:smithery:shuriken_assembly>);
