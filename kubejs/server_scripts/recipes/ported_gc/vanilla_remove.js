...
ServerEvents.recipes(event => {
    ...
    const outputs = [
        ...
        'cyclic:wireless_item','cyclic:wireless_energy','cyclic:wireless_fluid',
        'cyclic:item_pipe','cyclic:energy_pipe','cyclic:fluid_pipe',
        'cyclic:battery','cyclic:wand_hypno','cyclic:heart','cyclic:sleeping_mat',
        'cyclic:experience_pylon','cyclic:sprinkler','cyclicmagic:block_miner',
        'cyclic:slingshot','cyclicmagic:tool_swap_match','cyclicmagic:tool_swap',
        'cyclicmagic:cyclic_wand_build','cyclic:collector','cyclicmagic:bundled_pipe',
        'cyclic:magic_net','cyclicmagic:magnet_anti_block','cyclic:harvester',
        'cyclicmagic:tool_push','cyclic:spikes_diamond',
        ...
        'astralsorcery:black_marble','thermal:lumium_ingot',
        ...
        'xnet:netcable',
        'solarflux:sp_2','solarflux:sp_3','solarflux:sp_4',
        'solarflux:sp_5','solarflux:sp_6','solarflux:sp_7',
        'solarflux:sp_8','solarflux:sp_de.wyvern','solarflux:sp_de.draconic',
        ...
        'bloodmagic:soulforge','thaumcraft:amber_brick',
        ...
        'cyclic:crystal_helmet','cyclic:crystal_chestplate',
        'cyclic:crystal_leggings','cyclic:crystal_boots',
        ...
        'torchmaster:megatorch','torchmaster:feral_flare_lantern','torchmaster:dreadlamp',
        'globalxp:xp_block',
